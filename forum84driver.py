...
net = get_net("pickleX84.p")

forum = get('forum84', 'topics_id, users_id')

thread = get('forum84usercount', 'topics_id', modifier= 'where users > 50') # needs to be distinct
...
#Questions for Marin: What is PNE? Need access to database with forum 84! How to get root neighbor for negative samples?
